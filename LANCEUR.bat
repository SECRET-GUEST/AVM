...
if "%conda_exists%" == "F" (
	...
	mkdir "%INSTALL_DIR%"
	call powershell -Command "Invoke-WebRequest -Uri %MINICONDA_DOWNLOAD_URL% -OutFile %INSTALL_DIR%\\miniconda_installer.exe" || ( echo. && echo Miniconda failed to download. && goto end )
